...
class Palletizing_Robot():
    def __init__(self,COM,robot_speed=100,x_shift=50,y_shift=-50,pump_time=1) -> None:
        ...
        self.coords = [
            ...
            [-13.13, 277.26, 0, 38],#二维码码垛位置点
             [-13.13, 277.26, 30, 38],#颜色案例码垛位置点
    ...
    def color_judge(self,id):
        if id =='red' :                 
            self.ua.set_angles(self.angles[1],self.speed)
            self.ua.sync()
            self.ua.set_coords([self.coords[2][0],self.coords[2][1],134,self.coords[2][3]],self.speed)
            self.ua.sync()
            self.ua.set_coords([self.coords[2][0],self.coords[2][1],self.coords[2][2]+self.a_flag*self.Z_flag,self.coords[2][3]],self.lift_speed)
            self.ua.sync()
            self.pub_pump(False)
            time.sleep(self.time)
            self.ua.set_coord("Z",134,self.lift_speed)
            ...
            self.ua.set_angles(self.angles[1],self.speed)
            self.ua.sync()
            self.ua.set_coords([self.coords[2][0]+self.x_shif*2,self.coords[2][1],134,self.coords[2][3]],self.speed)
            self.ua.sync()
            self.ua.set_coords([self.coords[2][0]+self.x_shif*2,self.coords[2][1],self.coords[2][2]+self.b_flag*self.Z_flag,self.coords[2][3]],self.lift_speed)
            self.ua.sync()
            self.pub_pump(False)
            time.sleep(self.time)
            self.ua.set_coord("Z",134,self.lift_speed)
            ...
            self.ua.set_angles(self.angles[1],self.speed)
            self.ua.sync()
            self.ua.set_coords([self.coords[2][0]+self.x_shif*2,self.coords[2][1]+self.y_shif*2,134,self.coords[2][3]],self.speed)
            self.ua.sync()
            self.ua.set_coords([self.coords[2][0]+self.x_shif*2,self.coords[2][1]+self.y_shif*2,self.coords[2][2]+self.c_flag*self.Z_flag,self.coords[2][3]],self.lift_speed)
            self.ua.sync()
            self.pub_pump(False)
            time.sleep(self.time)
            self.ua.set_coord("Z",134,self.lift_speed)
            ...
            self.ua.set_angles(self.angles[1],self.speed)
            self.ua.sync()
            self.ua.set_coords([self.coords[2][0],self.coords[2][1]+self.y_shif*2,134,self.angel_reversal],self.speed)
            self.ua.sync()
            self.ua.set_coords([self.coords[2][0],self.coords[2][1]+self.y_shif*2,self.coords[2][2]+self.d_flag*self.Z_flag,self.angel_reversal],self.lift_speed)
            self.ua.sync()
            self.pub_pump(False)
            time.sleep(self.time)
            self.ua.set_coord("Z",134,self.lift_speed)
